<div>
    <img class="fixed inset-0 w-full z-0 opacity-25" src="https://gopos.id/wp-content/uploads/2020/03/WhatsApp-Image-2020-03-25-at-15.33.29.jpeg" alt="">
   <div class="fixed inset-0 h-screen">
    <div class="flex flex-col h-screen justify-center items-center z-10">
        ...
        <h1 class="text-gray-700 font-semibold">SELAMAT DATANG DI WEBSITE PENDAFTARAN MABA</h1>
